...
class SpeedAndDistanceEstimator():
    def __init__(self):
        self.frame_window = 5   # every 5 frames
        ...
        for object, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, player in object_tracks[frame_num].items():
                    ...
                    start_position = player["position_transformed"]
                    end_position = tracks[object][last_frame][track_id]["position_transformed"]
    ...
    def draw_speed_and_distance_in_place(self, frames, tracks):
        ...
        for frame_num, frame in enumerate(frames):
            for object, object_tracks in tracks.items():
                ...
                for track_id, track_info in object_tracks[frame_num].items():
                    ...
                    position = (position[0],position[1]+40) # a little below the circle and the rectangle with track id
